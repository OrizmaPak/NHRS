...
export const navigationItems: NavigationItem[] = [
  ...
  { label: 'Encounters', to: '/app/provider/encounters', permission: 'encounters.view', icon: ClipboardList },
  { label: 'Labs', to: '/app/provider/labs', permission: 'labs.view', icon: NotebookTabs },
  { label: 'Pharmacy', to: '/app/provider/pharmacy', permission: 'pharmacy.view', icon: BuildingIcon },
