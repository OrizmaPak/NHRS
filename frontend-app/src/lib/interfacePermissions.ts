...
export const interfacePermissions: InterfacePermission[] = [
  ...
  makeEntry('admin.users.manage', 'Admin Users', '/app/admin/users', 'admin', 'Access admin users interface'),
  makeEntry('admin.roles.manage', 'Admin Roles', '/app/admin/roles', 'admin', 'Access admin roles interface'),
  makeEntry('admin.institutions.manage', 'Admin Institutions', '/app/admin/institutions', 'admin', 'Access admin institutions interface'),
