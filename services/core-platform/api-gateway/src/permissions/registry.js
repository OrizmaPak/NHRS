const permissionRegistry = [
  ...
  { method: 'POST', path: '/global-services', permissionKey: 'global.services.manage' },
  { method: 'DELETE', path: '/global-services/:serviceId', permissionKey: 'global.services.manage' },
